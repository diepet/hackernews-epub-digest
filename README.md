...
| :--- | :--- | :--- |
| `LLM_MODEL` | *Required* | The LLM provider and model by using the LiteLLM syntax (e.g., `gemini/gemini-1.5-flash`, `openai/gpt-4o`): [https://docs.litellm.ai/docs/providers](https://docs.litellm.ai/docs/providers) |
